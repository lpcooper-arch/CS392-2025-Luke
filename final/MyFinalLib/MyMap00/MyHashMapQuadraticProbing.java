...
public class MyHashMapQuadraticProbing<V> implements MyMap00<String, V> {
    // HX-2025-11-12:
    ...
    public static void main(String[] args) {
        ...
        MyHashMapQuadraticProbing<Integer> map = new MyHashMapQuadraticProbing<>(10);
...
// contains the Quadratic Probing implementation of Hashtable made in Assign08_02